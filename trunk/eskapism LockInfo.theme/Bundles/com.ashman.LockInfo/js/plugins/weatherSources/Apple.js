...
function validateWeatherLocation(location, callback, id, locationIndex){
...
function xml_validateloaded(event, request, callback, id, locationIndex){
	if(request.responseXML){
		var obj ={id:id, error:false, errorString:null, cities:new Array, refine:false, idx: locationIndex};
		var adc_Database = findChild(request.responseXML, "adc_Database");
